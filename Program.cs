        ...
        while ((lineData = reader.ReadLine()) != null)
        {
            ...
            if (lineData.Contains("ClientUserinfoChanged:"))
            {
                ...
                if (!userIdList.ContainsKey(userId) && !userIdListTemp.ContainsKey(userId))
                {
                    ...
                    commentedData += ($"\n{lineData} \n* O player {name} entrou na partida.");
                }
                else if (userIdList.ContainsKey(userId))
                {
                    commentedData += ($"\n{lineData} \n* O player {userIdList[userId].Name} mudou o nome para {name}.");
                ...
                {
                    commentedData += ($"\n{lineData} \n* O player {userIdListTemp[userId].Name} mudou o nome para {name}.");
